...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "Buku Panduan Uji KIR",

	// 站点副标题
	subtitle: "Panduan Praktis Uji Berkala Kendaraan",
	...
	// 站点描述
	description:
		"Panduan modern dan praktis tentang Uji Berkala Kendaraan Bermotor (KIR) di Indonesia, disusun dari perspektif praktisi lapangan untuk memudahkan pemilik kendaraan dan operator transportasi.",
